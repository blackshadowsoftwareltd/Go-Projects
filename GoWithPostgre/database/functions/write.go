...
func AddUserToDB(
	...
	insertStatement := fmt.Sprintf("INSERT INTO public.user_info(id,name, email, password, address, designation, age)VALUES (2,'%s', '%s', '%s', '%s', '%s', %d);", user.Name, user.Email, user.Password, user.Address, user.Designation, user.Age)
